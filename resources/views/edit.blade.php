        ...
        <div class="container">
            ...
            <form action="{{ route('customer.update', $customer->id) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="document" required value="{{ $customer->document }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="observations" value="{{ $customer->observations }}">
                </div>
